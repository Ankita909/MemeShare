...
// Request a string response from the provided URL.
        ...
        val jsonObjectRequest = JsonObjectRequest(Request.Method.GET, currentImageUrl, null,
            Response.Listener { response ->
                ...
                val imageView = findViewById<View>(R.id.iVMeme)
...
// Add the request to the RequestQueue.
    ...
    fun shareMeme(view: android.view.View) {
        ...
        val chooser = Intent.createChooser(intent,"If you liked it,you can share this Meme using...")
